const descriptionTexts = [
    ...
    `, link: 'https://vitejs.dev/', img: './vite2.svg', color: 'from-blue-500 via-amber-400 to-violet-700'},
    { id: 2, text: `
    ...
    `, link: 'https://react.dev/', img: './react.svg', color: 'from-cyan-400 via-sky-400 to-blue-400'},
    { id: 3, text: `
    ...
    `, link: 'https://tailwindcss.com/docs/installation/framework-guides', img: './tailwind.svg', color: 'from-emerald-400 via-teal-500 to-cyan-500'},
    { id: 4, text: `
    ...
    `, link: 'https://tanstack.com/query/latest/', img: './react-query.svg', color: 'from-red-500 via-orange-500 to-amber-500'},
    { id: 5, text: `
    ...
    `, link: 'https://reactrouter.com/en/main', img: './react-router.svg', color: 'from-pink-500 via-emerald-400 to-indigo-700'},
]
